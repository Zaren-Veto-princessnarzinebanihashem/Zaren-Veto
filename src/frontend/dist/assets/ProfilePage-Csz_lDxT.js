const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DXe1TNIQ.js","assets/index-CinqF2FC.js","assets/index-SgxxC9VH.css"])))=>i.map(i=>d[i]);
import { b as createLucideIcon, d as useQueryClient, u as useNavigate, a as useLanguage, f as useParams, r as reactExports, j as jsxRuntimeExports, X, m as motion, S as Skeleton, e as ue, _ as __vitePreload } from "./index-CinqF2FC.js";
import { L as Layout, i as isVerifiedUser, V as VerificationBadge, O as OWNER_PROFILE_LINE1, o as OWNER_PROFILE_LINE2, U as Users, G as Globe } from "./Layout-B_cAPpUr.js";
import { B as Badge } from "./badge-JKO46TMB.js";
...
import { u as useCurrentUser, a as useAuthenticatedBackend, c as useMutation, b as useQuery, V as Visibility, f as ReactionType } from "./index-DXe1TNIQ.js";
import { u as useImageUpload, C as Camera } from "./useImageUpload-BCVE_Pwr.js";
import { U as UserMinus } from "./user-minus-BZs_1qyd.js";
import { F as FileText } from "./file-text-Cq5s7rZH.js";
import { B as Bookmark, L as Link2, P as Pin, C as ChevronUp, a as ChevronDown } from "./pin-DiscvcXq.js";
import { I as ImagePlus } from "./image-plus-tmLruMnO.js";
import { C as Check } from "./check-DftDiFuj.js";
import { L as Lock } from "./lock-CzUPLmOL.js";
import { T as Trash2 } from "./trash-2-kpsK9CZl.js";
import { H as Heart } from "./heart-BNZdwbhC.js";
import { M as MessageSquare } from "./message-square-B189Vqel.js";
import { S as Share2 } from "./share-2-CsD7OzOs.js";
    ...
    queryFn: async () => {
      ...
      try {
        const { Principal } = await __vitePreload(async () => {
          const { Principal: Principal2 } = await import("./index-DXe1TNIQ.js").then((n) => n.i);
    ...
    motion.div,
    {
      ...
      children: [
        ...
        editing ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          profile.aboutBio && !isOwnerVerified && !isVerifiedUser(profile.username, profile.isVerified) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: profile.aboutBio }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl overflow-hidden shadow-sm", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `px-6 pb-6 ${isRTL ? "rtl" : ""}`, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 space-y-1", children: [
        ...
        profile.bio && !isVerified && !isVerifiedUser(profile.username, profile.isVerified) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed max-w-lg break-words", children: profile.bio }),
