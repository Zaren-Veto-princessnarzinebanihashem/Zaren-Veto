import { b as createLucideIcon, a as useLanguage, r as reactExports, j as jsxRuntimeExports, X, S as Skeleton, m as motion, A as AnimatePresence, u as useNavigate } from "./index-I4BClEcX.js";
import { L as Layout, C as Compass, g as User, V as VerificationBadge } from "./Layout-ylNcgSWV.js";
import { B as Button } from "./button-GaH6HiRE.js";
import { I as Input } from "./input-EG1XOUZJ.js";
import { a as useAuthenticatedBackend, b as useQuery } from "./useCurrentUser-BgKU1S1t.js";
import { S as Search } from "./search-DyP8OZJp.js";
import { U as UserCheck } from "./user-check-OJvlskFJ.js";
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 border-t border-border flex items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  className: `flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-medium transition-colors ${isLiked ? "text-[#1877F2] bg-[#1877F2]/10" : "text-muted-foreground hover:bg-secondary hover:text-foreground"}`,
                  "data-ocid": "post-modal.like_button",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: `w-4 h-4 ${isLiked ? "fill-[#1877F2]" : ""}` }),
                    isLiked ? "Liked" : "Like"
                  ]
                }
              ),
