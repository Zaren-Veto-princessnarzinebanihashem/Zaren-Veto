const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-B-1M6gbA.js","assets/index-I4BClEcX.js","assets/index-v9G-3vDu.css"])))=>i.map(i=>d[i]);
import { b as createLucideIcon, d as useQueryClient, u as useNavigate, a as useLanguage, f as useParams, r as reactExports, j as jsxRuntimeExports, X, m as motion, S as Skeleton, e as ue, _ as __vitePreload } from "./index-I4BClEcX.js";
import { L as Layout, i as isVerifiedUser, V as VerificationBadge, O as OWNER_PROFILE_LINE1, o as OWNER_PROFILE_LINE2, U as Users, G as Globe } from "./Layout-ylNcgSWV.js";
import { B as Badge } from "./badge-Cti5byWF.js";
import { B as Button } from "./button-GaH6HiRE.js";
import { I as Input } from "./input-EG1XOUZJ.js";
import { L as Label } from "./label-D7XWYETp.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-DeFAOZYA.js";
import { T as Textarea } from "./textarea-D7ZSVHLQ.js";
import { u as useCurrentUser, a as useAuthenticatedBackend, c as useMutation, b as useQuery, V as Visibility, f as ReactionType } from "./useCurrentUser-BgKU1S1t.js";
import { u as useImageUpload, C as Camera } from "./useImageUpload-B20kQ2N-.js";
import { U as UserMinus } from "./user-minus-D3GCvnqx.js";
import { F as FileText } from "./file-text-SPtuf3L-.js";
import { B as Bookmark, L as Link2, P as Pin, C as ChevronUp, a as ChevronDown } from "./pin-CxxRS2DO.js";
import { I as ImagePlus } from "./index-B-1M6gbA.js";
import { C as Check } from "./check-EnClJrv6.js";
import { L as Lock } from "./lock-Bn8zuNpZ.js";
import { T as Trash2 } from "./trash-2-CuNgHV6z.js";
import { H as Heart } from "./heart-DtkTG6TC.js";
import { M as MessageSquare } from "./message-square-BMjJU0X1.js";
import { S as Share2 } from "./share-2-CCKyiZ9f.js";
import { S as Send } from "./send-Ddn28pa0.js";
/**
    ...
    queryFn: async () => {
      ...
      try {
        const { Principal } = await __vitePreload(async () => {
          const { Principal: Principal2 } = await import("./index-B-1M6gbA.js").then((n) => n.i);
...
function AboutSection({ profile, isOwnProfile }) {
  ...
  const [bio, setBio] = reactExports.useState(profile.aboutBio ?? "");
  ...
  const { t } = useLanguage();
  const hasInfo = profile.aboutBio || profile.aboutLocation || profile.aboutWork || profile.aboutEducation || profile.aboutWebsite;
    ...
    motion.div,
    {
      ...
      children: [
        ...
        editing ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          profile.aboutBio && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: profile.aboutBio }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl overflow-hidden shadow-sm", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `px-6 pb-6 ${isRTL ? "rtl" : ""}`, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 space-y-1", children: [
        ...
        profile.bio && !isVerified && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed max-w-lg break-words", children: profile.bio }),
...
function PostCard({
  ...
  const handleShare = () => {
    ...
    void navigator.clipboard.writeText(`${window.location.origin}/post/${postId}`).then(() => ue.success(t.linkCopied)).catch(() => ue.error(t.actionFailed));
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 py-2 border-t border-border/60 flex items-center gap-0.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: `w-4 h-4 ${isLiked ? "fill-red-500" : ""}` }),
