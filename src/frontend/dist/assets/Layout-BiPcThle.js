import { b as createLucideIcon, r as reactExports, j as jsxRuntimeExports, s as shimExports, c as cn, R as React, i as reactDomExports, k as React2, l as ReactDOM, h as useInternetIdentity, u as useNavigate, a as useLanguage, X, n as useRouterState } from "./index-B7Ujb7fy.js";
import { P as Primitive$1, g as composeRefs, d as useComposedRefs, u as useCurrentUser, a as useAuthenticatedBackend, b as useQuery } from "./index-BOifRTf6.js";
/**
...
const Compass = createLucideIcon("compass", __iconNode$9);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const ADMIN_USERNAME = "Princess Narzine Bani Hashem";
const OWNER_PROFILE_LINE1 = "Personnalité Publique";
const OWNER_PROFILE_LINE2 = "Page officielle de la Fondatrice de l'application Zaren Veto";
function normalizeUsername(name) {
  return name.toLowerCase().replace(/[\s_\-]/g, "");
}
function isVerifiedUser(username, isVerifiedFromBackend) {
  if (isVerifiedFromBackend === true) return true;
  if (!username) return false;
  const normalized = normalizeUsername(username);
  return normalized === "princessnarzinebanihashem" || normalized === "princessnarzine" || normalized === "narzinebanihashem";
}
function isOwnerProfile(username, isVerifiedFromBackend) {
      ...
      children: [
        ...
        hasUnread && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            ...
            children: unreadCount > 0 ? displayCount : null
          }
        )
      ]
    }
...
function VerificationBadge({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "span",
    {
      ...
      style: { width: size2, height: size2, lineHeight: 0 },
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "svg",
        {
          ...
          style: { display: "block" },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("polygon", { points: polygonPoints, fill: "#1877F2" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "path",
              {
...
function SearchDropdown({ onClose }) {
  ...
  const placeholder = t.exploreSearchPlaceholder ?? "Search users, posts or hashtags…";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ref: dropdownRef,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-3 py-2.5 border-b border-border", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-h-72 overflow-y-auto", children: [
          loading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center py-6 gap-2 text-sm text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-4 h-4 border-2 border-muted-foreground/30 border-t-muted-foreground rounded-full animate-spin block" }),
            t.searching ?? "Searching…"
          ] }),
          !loading && query.trim() && results.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-6 text-center text-sm text-muted-foreground", children: t.userNotFound ?? "No users found" }),
          !loading && !query.trim() && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-5 text-center text-xs text-muted-foreground", children: t.exploreTypeToSearch ?? "Type to search…" }),
          !loading && results.map((user) => {
            var _a;
            const userId = ((_a = user.id) == null ? void 0 : _a.toString()) ?? "";
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full bg-primary/10 border border-primary/20 flex items-center justify-center shrink-0 text-xs font-bold text-primary", children: user.username.slice(0, 1).toUpperCase() }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-w-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "p",
                    {
                      ...
                      children: [
                        ...
                        verified && /* @__PURE__ */ jsxRuntimeExports.jsx(VerificationBadge, { size: 14 })
                      ]
                    }
                  ) })
                ]
...
function Header() {
  ...
  const initials = (profile == null ? void 0 : profile.username) ? profile.username.slice(0, 2).toUpperCase() : "ZV";
  const isAdmin = isVerifiedUser((profile == null ? void 0 : profile.username) ?? "", profile == null ? void 0 : profile.isVerified);
  function cycleLanguage() {
    const idx = LANG_CYCLE.indexOf(language);
    const next = LANG_CYCLE[(idx + 1) % LANG_CYCLE.length];
    setLanguage(next);
  }
  const langLabel = language === "ar" ? t.langAr : language === "fr" ? t.langFr : t.langEn;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "header",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-3 sm:px-4 h-14 sm:h-16 flex items-center justify-between gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 sm:w-9 sm:h-9 flex items-center justify-center transition-smooth group-hover:scale-105", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldLogo, { className: "w-8 h-8 sm:w-9 sm:h-9 drop-shadow-sm" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden xs:inline font-display text-lg sm:text-xl font-semibold tracking-tight text-foreground", children: t.appName })
            ]
          }
        ),
        status === "authenticated" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate text-xs", children: t.exploreSearchPlaceholder ?? "Search users…" })
                  ]
                }
              ),
              searchOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(SearchDropdown, { onClose: () => setSearchOpen(false) })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 sm:gap-2", children: [
          status === "authenticated" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative sm:hidden", ref: searchContainerRef, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
            ...
            searchOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-full mt-1 end-0 w-[calc(100vw-1.5rem)] max-w-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SearchDropdown, { onClose: () => setSearchOpen(false) }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { className: "w-3.5 h-3.5 flex-shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold tracking-wide font-mono hidden sm:inline", children: langLabel })
              ]
            }
          ),
          status === "authenticated" && profile ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(NotificationBell, { unreadCount }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { className: "w-8 h-8 border border-primary/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "bg-primary/15 text-primary text-xs font-semibold", children: initials }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "span",
                      {
                        ...
                        children: [
                          ...
                          isAdmin && /* @__PURE__ */ jsxRuntimeExports.jsx(VerificationBadge, { size: 16 })
                        ]
                      }
                    )
                  ]
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      className: cn(
        ...
        isActive ? "bg-primary/15 text-primary metallic-border" : "text-muted-foreground hover:text-foreground hover:bg-secondary"
      ),
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden lg:block", children: item.label })
      ]
    }
  );
}
function Navigation({ mobileOnly = false }) {
  ...
  const staticNavItems = [
    { to: "/", label: t.feed, icon: House, ocid: "nav-feed" },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    !mobileOnly && /* @__PURE__ */ jsxRuntimeExports.jsx(
      "nav",
      {
        className: "hidden md:flex flex-col gap-1 p-3 w-56 lg:w-64 flex-shrink-0",
        "aria-label": "Main navigation",
        "data-ocid": "sidebar-nav",
        children: allNavItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          NavButton,
          {
            item,
        ...
        children: allNavItems.map((item) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                active && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-1.5 w-1 h-1 rounded-full bg-primary" }),
...
function Layout({ children, bare = false }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 max-w-6xl mx-auto w-full px-3 sm:px-4 gap-4 sm:gap-6 py-4 sm:py-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("aside", { className: "hidden md:block flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "sticky top-24", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, {}) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "main",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("style", { children: "@media (min-width: 768px) { #main-content { padding-bottom: 0 !important; } }" }),
            children
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "hidden md:block bg-card border-t border-border mt-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 py-4 flex flex-col sm:flex-row items-center justify-between gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
        "© ",
        currentYear,
        " Zaren Veto"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex items-center gap-4", "aria-label": "Footer links", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: "/privacy-policy",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            ...
            children: t.communityGuidelines
          }
        )
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, { mobileOnly: true })
  ] });
}
export {
  ADMIN_USERNAME as A,
