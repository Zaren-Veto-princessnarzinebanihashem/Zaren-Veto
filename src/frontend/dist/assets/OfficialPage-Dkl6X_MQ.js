...
import { b as createLucideIcon, u as useNavigate, a as useLanguage, d as useQueryClient, r as reactExports, j as jsxRuntimeExports, S as Skeleton, e as ue, _ as __vitePreload, m as motion, X } from "./index-I4BClEcX.js";
import { L as Layout, i as isVerifiedUser, U as Users, V as VerificationBadge } from "./Layout-ylNcgSWV.js";
import { B as Button } from "./button-GaH6HiRE.js";
import { T as Textarea } from "./textarea-D7ZSVHLQ.js";
import { a as useAuthenticatedBackend, u as useCurrentUser, c as useMutation, b as useQuery } from "./useCurrentUser-BgKU1S1t.js";
...
function OfficialPostCard({ post, index }) {
  ...
  const handleShare = () => {
    ...
    if ((_a = navigator.clipboard) == null ? void 0 : _a.writeText) {
      void navigator.clipboard.writeText(url).then(() => ue.success(t.linkCopied));
    }
  };
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                className: `flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-medium transition-smooth hover:bg-secondary ${liked ? "text-[#1877F2] font-semibold" : "text-muted-foreground hover:text-foreground"}`,
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 pb-5 pt-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1.5 space-y-0.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", style: { color: "#4169E1" }, children: "Personnalité Publique" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium", style: { color: "#4169E1" }, children: "Page officielle de la Fondatrice de l'application Zaren Veto" })
                ] }),
