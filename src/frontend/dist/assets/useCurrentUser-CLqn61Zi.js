...
import { i as ProtocolError, T as TimeoutWaitingForResponseErrorCode, k as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, l as lookupResultToBuffer, R as RequestStatusResponseStatus, U as UnknownError, n as RequestStatusDoneNoReplyErrorCode, o as RejectError, p as CertifiedRejectErrorCode, q as UNREACHABLE_ERROR, I as InputError, s as InvalidReadStateRequestErrorCode, t as ReadRequestType, P as Principal, v as IDL, w as MissingCanisterIdErrorCode, H as HttpAgent, x as encode, Q as QueryResponseStatus, y as UncertifiedRejectErrorCode, z as isV3ResponseBody, B as isV2ResponseBody, D as UncertifiedRejectUpdateErrorCode, F as UnexpectedErrorCode, G as decode, J as Subscribable, K as pendingThenable, L as resolveEnabled, N as shallowEqualObjects, O as resolveStaleTime, V as noop, W as environmentManager, Y as isValidTimeout, Z as timeUntilStale, $ as timeoutManager, a0 as focusManager, a1 as fetchState, a2 as replaceData, a3 as notifyManager, a4 as hashKey, a5 as getDefaultState, r as reactExports, a6 as shouldThrowError, d as useQueryClient, h as useInternetIdentity, a7 as createActorWithConfig, j as jsxRuntimeExports, a8 as React, a9 as Variant, aa as Record, ab as Opt, ac as Vec, ad as Service, ae as Func, af as Principal$1, ag as Text, ah as Nat, ai as Tuple, aj as Null, ak as Bool, al as Int, am as Nat8, an as Float64 } from "./index-DAQ2-jUM.js";
...
Service({
  ...
  "updateCoverPhoto": Func([Text], [], []),
  "updateProfile": Func([Text, Text, Visibility$1], [Bool], []),
  "updateProfilePhoto": Func([Text], [], []),
  "viewStory": Func([Nat], [], []),
...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  return IDL2.Service({
    ...
    "updateCoverPhoto": IDL2.Func([IDL2.Text], [], []),
    "updateProfile": IDL2.Func(
      [IDL2.Text, IDL2.Text, Visibility2],
      [IDL2.Bool],
      []
    ),
    "updateProfilePhoto": IDL2.Func([IDL2.Text], [], []),
...
class Backend {
  ...
  async createPost(arg0, arg1, arg2, arg3) {
    if (this.processError) {
      try {
        const result = await this.actor.createPost(arg0, to_candid_Visibility_n3(this._uploadFile, this._downloadFile, arg1), arg2, to_candid_opt_n1(this._uploadFile, this._downloadFile, arg3));
        return from_candid_variant_n2(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async createStory(arg0, arg1) {
    if (this.processError) {
      try {
        ...
        return from_candid_StoryView_n5(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
      }
  ...
  async getPollResults(arg0) {
    if (this.processError) {
      try {
        ...
        return from_candid_PollResults_n41(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
      }
  ...
  async reactToMessage(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.reactToMessage(arg0, to_candid_ReactionType_n53(this._uploadFile, this._downloadFile, arg1));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async reactToPost(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.reactToPost(arg0, to_candid_ReactionType_n53(this._uploadFile, this._downloadFile, arg1));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async registerWithPassword(arg0, arg1, arg2) {
    if (this.processError) {
      try {
  ...
  async resolveReport(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.resolveReport(arg0, to_candid_ResolveAction_n56(this._uploadFile, this._downloadFile, arg1));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async respondFriendRequest(arg0, arg1) {
    if (this.processError) {
      try {
        const result = await this.actor.respondFriendRequest(arg0, to_candid_RespondAction_n58(this._uploadFile, this._downloadFile, arg1));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
  ...
  async searchContent(arg0) {
    if (this.processError) {
      try {
        ...
        return from_candid_SearchResults_n60(this._uploadFile, this._downloadFile, result);
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
      }
  ...
  async updateProfile(arg0, arg1, arg2) {
    if (this.processError) {
      try {
        const result = await this.actor.updateProfile(arg0, arg1, to_candid_Visibility_n3(this._uploadFile, this._downloadFile, arg2));
        return result;
      } catch (e) {
        this.processError(e);
        throw new Error("unreachable");
...
function from_candid_CommentView_n14(_uploadFile, _downloadFile, value) {
  return from_candid_record_n15(_uploadFile, _downloadFile, value);
}
function from_candid_FriendRequestView_n39(_uploadFile, _downloadFile, value) {
  return from_candid_record_n40(_uploadFile, _downloadFile, value);
}
function from_candid_MessageReactionView_n21(_uploadFile, _downloadFile, value) {
  return from_candid_record_n22(_uploadFile, _downloadFile, value);
}
function from_candid_MessageView_n24(_uploadFile, _downloadFile, value) {
  return from_candid_record_n25(_uploadFile, _downloadFile, value);
}
function from_candid_NotificationType_n35(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n36(_uploadFile, _downloadFile, value);
}
function from_candid_NotificationView_n33(_uploadFile, _downloadFile, value) {
  return from_candid_record_n34(_uploadFile, _downloadFile, value);
}
function from_candid_PollResults_n41(_uploadFile, _downloadFile, value) {
  return from_candid_record_n42(_uploadFile, _downloadFile, value);
}
function from_candid_PostView_n18(_uploadFile, _downloadFile, value) {
  return from_candid_record_n19(_uploadFile, _downloadFile, value);
}
function from_candid_ReactionType_n29(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n30(_uploadFile, _downloadFile, value);
}
function from_candid_ReportView_n47(_uploadFile, _downloadFile, value) {
  return from_candid_record_n48(_uploadFile, _downloadFile, value);
}
function from_candid_SearchResults_n60(_uploadFile, _downloadFile, value) {
  return from_candid_record_n61(_uploadFile, _downloadFile, value);
}
function from_candid_StoryFeed_n51(_uploadFile, _downloadFile, value) {
  return from_candid_record_n52(_uploadFile, _downloadFile, value);
}
function from_candid_StoryView_n5(_uploadFile, _downloadFile, value) {
  return from_candid_record_n6(_uploadFile, _downloadFile, value);
}
function from_candid_UserProfile_n7(_uploadFile, _downloadFile, value) {
  return from_candid_record_n8(_uploadFile, _downloadFile, value);
}
function from_candid_Visibility_n10(_uploadFile, _downloadFile, value) {
...
function from_candid_opt_n28(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : from_candid_ReactionType_n29(_uploadFile, _downloadFile, value[0]);
}
function from_candid_opt_n43(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : value[0];
}
function from_candid_opt_n49(_uploadFile, _downloadFile, value) {
  return value.length === 0 ? null : from_candid_PostView_n18(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n15(_uploadFile, _downloadFile, value) {
  return {
    ...
    parentId: record_opt_to_undefined(from_candid_opt_n16(_uploadFile, _downloadFile, value.parentId)),
    postId: value.postId
  };
}
function from_candid_record_n19(_uploadFile, _downloadFile, value) {
  return {
    ...
    content: value.content,
    authorProfilePhoto: record_opt_to_undefined(from_candid_opt_n9(_uploadFile, _downloadFile, value.authorProfilePhoto)),
    authorId: value.authorId,
    createdAt: value.createdAt,
    authorName: value.authorName,
    updatedAt: value.updatedAt,
...
function from_candid_record_n22(_uploadFile, _downloadFile, value) {
  return {
    reactor: from_candid_UserProfile_n7(_uploadFile, _downloadFile, value.reactor),
...
function from_candid_record_n25(_uploadFile, _downloadFile, value) {
  return {
    ...
    readAt: record_opt_to_undefined(from_candid_opt_n26(_uploadFile, _downloadFile, value.readAt))
  };
}
function from_candid_record_n34(_uploadFile, _downloadFile, value) {
  return {
    ...
    notifType: from_candid_NotificationType_n35(_uploadFile, _downloadFile, value.notifType),
    createdAt: value.createdAt,
    isRead: value.isRead,
...
function from_candid_record_n37(_uploadFile, _downloadFile, value) {
  return {
    reaction: from_candid_ReactionType_n29(_uploadFile, _downloadFile, value.reaction),
    postId: value.postId
  };
}
function from_candid_record_n40(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    to: from_candid_UserProfile_n7(_uploadFile, _downloadFile, value.to),
    status: value.status,
    from: from_candid_UserProfile_n7(_uploadFile, _downloadFile, value.from),
    createdAt: value.createdAt
  };
}
function from_candid_record_n42(_uploadFile, _downloadFile, value) {
  return {
    ...
    myVote: record_opt_to_undefined(from_candid_opt_n43(_uploadFile, _downloadFile, value.myVote)),
...
function from_candid_record_n48(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    status: value.status,
    reportedPost: record_opt_to_undefined(from_candid_opt_n49(_uploadFile, _downloadFile, value.reportedPost)),
    reportedUser: record_opt_to_undefined(from_candid_opt_n27(_uploadFile, _downloadFile, value.reportedUser)),
    createdAt: value.createdAt,
    reporter: from_candid_UserProfile_n7(_uploadFile, _downloadFile, value.reporter),
    reason: value.reason
  };
}
function from_candid_record_n52(_uploadFile, _downloadFile, value) {
  return {
    stories: from_candid_vec_n31(_uploadFile, _downloadFile, value.stories),
    author: from_candid_UserProfile_n7(_uploadFile, _downloadFile, value.author),
...
function from_candid_record_n6(_uploadFile, _downloadFile, value) {
  return {
    ...
    textOverlay: record_opt_to_undefined(from_candid_opt_n9(_uploadFile, _downloadFile, value.textOverlay)),
...
function from_candid_record_n61(_uploadFile, _downloadFile, value) {
  return {
    ...
    posts: from_candid_vec_n17(_uploadFile, _downloadFile, value.posts)
  };
}
function from_candid_record_n8(_uploadFile, _downloadFile, value) {
  return {
    ...
    aboutWebsite: record_opt_to_undefined(from_candid_opt_n9(_uploadFile, _downloadFile, value.aboutWebsite)),
    birthdate: record_opt_to_undefined(from_candid_opt_n9(_uploadFile, _downloadFile, value.birthdate)),
    isOfficialPage: value.isOfficialPage,
    isVerified: value.isVerified,
    aboutBio: record_opt_to_undefined(from_candid_opt_n9(_uploadFile, _downloadFile, value.aboutBio)),
    aboutWork: record_opt_to_undefined(from_candid_opt_n9(_uploadFile, _downloadFile, value.aboutWork)),
    aboutLocation: record_opt_to_undefined(from_candid_opt_n9(_uploadFile, _downloadFile, value.aboutLocation)),
    followerCount: value.followerCount,
    followingCount: value.followingCount,
    profilePhotoUrl: record_opt_to_undefined(from_candid_opt_n9(_uploadFile, _downloadFile, value.profilePhotoUrl)),
    visibility: from_candid_Visibility_n10(_uploadFile, _downloadFile, value.visibility),
    coverPhotoUrl: record_opt_to_undefined(from_candid_opt_n9(_uploadFile, _downloadFile, value.coverPhotoUrl)),
    aboutEducation: record_opt_to_undefined(from_candid_opt_n9(_uploadFile, _downloadFile, value.aboutEducation))
  };
}
...
function from_candid_variant_n36(_uploadFile, _downloadFile, value) {
  return "verified" in value ? {
    ...
    __kind__: "reaction",
    reaction: from_candid_record_n37(_uploadFile, _downloadFile, value.reaction)
  } : "follow" in value ? {
    __kind__: "follow",
    follow: value.follow
  } : value;
...
function from_candid_vec_n13(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_CommentView_n14(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n17(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_PostView_n18(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n20(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_MessageReactionView_n21(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n23(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_MessageView_n24(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n31(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_StoryView_n5(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n32(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_NotificationView_n33(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n38(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_FriendRequestView_n39(_uploadFile, _downloadFile, x));
}
...
function from_candid_vec_n46(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_ReportView_n47(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n50(_uploadFile, _downloadFile, value) {
  return value.map((x) => from_candid_StoryFeed_n51(_uploadFile, _downloadFile, x));
}
function to_candid_ReactionType_n53(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n54(_uploadFile, _downloadFile, value);
}
function to_candid_ResolveAction_n56(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n57(_uploadFile, _downloadFile, value);
}
function to_candid_RespondAction_n58(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n59(_uploadFile, _downloadFile, value);
}
function to_candid_Visibility_n3(_uploadFile, _downloadFile, value) {
...
function useCurrentUser() {
  ...
  } else if (profile === null || profile === void 0) {
    status = "registering";
  } else {
