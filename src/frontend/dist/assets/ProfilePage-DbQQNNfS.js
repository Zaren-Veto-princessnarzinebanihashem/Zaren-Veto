const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-DSDpu3c4.js","assets/index-CRJrpZcN.js","assets/index-CGQWYetb.css"])))=>i.map(i=>d[i]);
import { b as createLucideIcon, d as useQueryClient, u as useNavigate, a as useLanguage, f as useParams, r as reactExports, j as jsxRuntimeExports, X, m as motion, S as Skeleton, e as ue, _ as __vitePreload } from "./index-CRJrpZcN.js";
import { L as Layout, i as isVerifiedUser, V as VerificationBadge, o as isOwnerProfile, O as OWNER_PROFILE_LINE1, p as OWNER_PROFILE_LINE2, U as Users, G as Globe } from "./Layout-1CdJlI07.js";
import { B as Badge } from "./badge-D73oIZM7.js";
...
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-BTFozbb8.js";
import { T as Textarea } from "./textarea-BZuuetXX.js";
import { u as useCurrentUser, a as useAuthenticatedBackend, c as useMutation, b as useQuery, V as Visibility, e as ReactionType } from "./index-DSDpu3c4.js";
import { u as useImageUpload, C as Camera } from "./useImageUpload-Ca0YbKEj.js";
import { U as UserMinus } from "./user-minus-7LKOtpO3.js";
import { F as FileText } from "./file-text-CnxR1vW8.js";
import { B as Bookmark, L as Link2, P as Pin, C as ChevronUp, a as ChevronDown } from "./pin-Cq_ytgx9.js";
import { I as ImagePlus } from "./image-plus-C6HCDnCD.js";
    ...
    queryFn: async () => {
      ...
      try {
        const { Principal } = await __vitePreload(async () => {
          const { Principal: Principal2 } = await import("./index-DSDpu3c4.js").then((n) => n.i);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl overflow-hidden shadow-sm", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `px-6 pb-6 ${isRTL ? "rtl" : ""}`, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 space-y-1", children: [
        ...
        profile.bio && !isVerified && !isOwnerProfile(profile.username, profile.isVerified) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed max-w-lg break-words", children: profile.bio }),
