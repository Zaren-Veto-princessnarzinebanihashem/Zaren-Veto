const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BOifRTf6.js","assets/index-B7Ujb7fy.js","assets/index-CxBod8fv.css"])))=>i.map(i=>d[i]);
import { b as createLucideIcon, d as useQueryClient, u as useNavigate, a as useLanguage, f as useParams, r as reactExports, j as jsxRuntimeExports, X, m as motion, S as Skeleton, e as ue, _ as __vitePreload } from "./index-B7Ujb7fy.js";
import { L as Layout, i as isVerifiedUser, V as VerificationBadge, o as isOwnerProfile, O as OWNER_PROFILE_LINE1, p as OWNER_PROFILE_LINE2, U as Users, G as Globe } from "./Layout-BiPcThle.js";
import { B as Badge } from "./badge-C5WcE9hy.js";
import { B as Button } from "./button-BuwYjKTK.js";
import { I as Input } from "./input-B8D9MagB.js";
import { L as Label } from "./label-DqXqNI9D.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-lomfpv9Q.js";
import { T as Textarea } from "./textarea-CD0Zi2ia.js";
import { u as useCurrentUser, a as useAuthenticatedBackend, c as useMutation, b as useQuery, V as Visibility, f as ReactionType } from "./index-BOifRTf6.js";
import { u as useImageUpload, C as Camera } from "./useImageUpload-CnnM4Da_.js";
import { U as UserMinus } from "./user-minus-BQUE2IKH.js";
import { F as FileText } from "./file-text-DmItaXbB.js";
import { B as Bookmark, L as Link2, P as Pin, C as ChevronUp, a as ChevronDown } from "./pin-Cc_emdsq.js";
import { I as ImagePlus } from "./image-plus-FXKjDFi0.js";
import { C as Check } from "./check-CIiqzpji.js";
import { L as Lock } from "./lock-S9kS0JcL.js";
import { T as Trash2 } from "./trash-2-BqJ2MPTY.js";
import { H as Heart } from "./heart-YzMPyhL8.js";
import { M as MessageSquare } from "./message-square-B0w4ZL51.js";
import { S as Share2 } from "./share-2-B44IueuS.js";
import { S as Send } from "./send-rFBgf7qd.js";
/**
    ...
    queryFn: async () => {
      ...
      try {
        const { Principal } = await __vitePreload(async () => {
          const { Principal: Principal2 } = await import("./index-BOifRTf6.js").then((n) => n.i);
...
function StatBlock({
  ...
  const display = typeof value === "string" ? value : Number(value).toLocaleString();
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 space-y-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-semibold text-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center", style: { gap: "3px" }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: profile.username }),
                isVerified && /* @__PURE__ */ jsxRuntimeExports.jsx(VerificationBadge, { size: 22 })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(VisibilityBadge, { visibility: profile.visibility })
            ]
          }
        ),
        profile.bio && !isOwnerProfile(profile.username, profile.isVerified) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed max-w-lg break-words", children: profile.bio }),
        isOwnerProfile(profile.username, profile.isVerified) && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 pt-4 pb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground leading-relaxed flex-1 min-w-0 break-words", children: post.content }),
